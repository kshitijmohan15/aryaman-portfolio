  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="w-full h-[600px] md:h-[800px] lg:h-[900px] relative rounded-lg overflow-hidden shadow-lg">
        <iframe
          src="https://storage.googleapis.com/portfolio-pdfs-dev/aryaman-portfolio/pdfs/pitch-deck-prepr.pdf"
          className="w-full h-full border-0"
          title="Prepr Pitch Deck"
        />
        <div className="md:hidden absolute inset-0 bg-black/50 flex items-center justify-center">
          <a 
            href="https://storage.googleapis.com/portfolio-pdfs-dev/aryaman-portfolio/pdfs/pitch-deck-prepr.pdf" 
            target="_blank"
